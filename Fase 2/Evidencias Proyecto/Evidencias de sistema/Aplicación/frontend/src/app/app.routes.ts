...
export const routes: Routes = [
  ...
  {
    path: 'seguimiento-mantenimiento',
    component: SeguimientoMantenimientoComponent,
  },
  {
    path: 'seguimiento-mantenimiento/:id',
    component: SeguimientoMantenimientoComponent,
  },
  { path: 'registrar-soap/:id', component: RegistrarSoapComponent },
  {
    path: 'registrar-seguro/:id',
    component: RegistrarSeguroVehicularComponent,
  },
